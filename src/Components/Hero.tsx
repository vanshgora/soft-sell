        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              SoftSell helps businesses and individuals sell their unused software licenses quickly and securely for the best market rates.
            </motion.p>
            ...
            >
              ...
              >
                ...
                >500+</motion.span> satisfied customers this month
              </motion.p>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="relative w-full max-w-lg">
              <motion.div 
                className="absolute top-0 -left-4 w-72 h-72 bg-blue-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20"
                animate={{
                  scale: [1, 1.1, 1],
                  opacity: [0.2, 0.3, 0.2],
                }}
              ...
              ></motion.div>
              <motion.div 
                className="absolute bottom-0 right-0 w-72 h-72 bg-green-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20"
                animate={{
                  scale: [1, 1.2, 1],
              ...
              >
                ...
                >
                  ...
                  <div>
                    <p className="font-bold">Recent valuation</p>
                    <p className="text-sm text-gray-500">Enterprise software license</p>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <p className="text-sm text-blue-800">Get paid within 48 hours after valuation</p>
                  </div>
                </motion.div>
              </motion.div>
            </div>
